...
public class AbstractCombatSpellTest<X extends CombatSpell> extends AbstractOrderTest<X>
{
  private static final Logger LOG = Logger.getLogger( AbstractCombatSpellTest.class );
