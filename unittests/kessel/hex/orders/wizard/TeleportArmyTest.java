...
public class TeleportArmyTest extends AbstractTeleportArmyTest<TeleportArmy>
{
  private static final Logger LOG = Logger.getLogger( TeleportArmyTest.class );
  ...
  public void testPersistence() throws Exception
  {
    ...
    wizard.setBase( army );
    TeleportArmy oldOrder = new TeleportArmy( wizard, new Tuple( 2, 2 ) );

    String jsonOrder = Game.GSON.toJson( oldOrder );
    LOG.debug( jsonOrder );
    TeleportArmy newOrder = Game.GSON.fromJson( jsonOrder, TeleportArmy.class );
  ...
  public void testNotInArmy()
  {
    ...
    wizard.setLevel( 5 );
    TeleportArmy order = new TeleportArmy( wizard, new Tuple( 2, 2 ) );
